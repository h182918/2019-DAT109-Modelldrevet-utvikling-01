...
#pragma include_alias(".\\LoginQRCode.h", "/LoginQRCode.h")
#else
...
#include <cassert>
#include "stdio.h"
#define LoginQRCode_ENUM_BEGIN   namespace LoginQRCode_ENUM{
#define LoginQRCode_ENUM_END   }
#define State   ::LoginQRCode_ENUM::State_
//------------------------------
//NAMESPACES AND PREDEFINITIONS
//------------------------------
#ifdef __cplusplus
LoginQRCode_ENUM_BEGIN
LoginQRCode_ENUM_END
#endif 
